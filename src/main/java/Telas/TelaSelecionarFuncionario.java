 ...
 * @author Vitor Hugo
 */
public class TelaSelecionarFuncionario extends javax.swing.JFrame {
    ...
    public void GerarContracheque(int idFuncionario) throws SQLException, ParseException {
        ...
        var retorno = BancoMysql.ExecutarConsulta("select * from funcionarios where idFuncionarios = " + idFuncionario);
        while (retorno.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecionarFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaSelecionarFuncionario().setVisible(true);
            }
        });
    }
